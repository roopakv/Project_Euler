...
${OBJECTDIR}/problem13.o: problem13.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/problem13.o problem13.cpp

${OBJECTDIR}/_ext/723857475/random.o: /cygdrive/D/development/ProjectEuler/random.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/723857475
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/723857475/random.o /cygdrive/D/development/ProjectEuler/random.cpp
...
${OBJECTDIR}/problem17.o: problem17.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/problem17.o problem17.cpp

${OBJECTDIR}/_ext/723857475/problem14.o: /cygdrive/D/development/ProjectEuler/problem14.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/723857475
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/723857475/problem14.o /cygdrive/D/development/ProjectEuler/problem14.cpp
